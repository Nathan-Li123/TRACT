...
model = dict(
    ...
    benchmark = 'tao',
    public_det_path = 'results/public_dets/tao_val_dets/teta_50_internms/yolow_tao_val_det/',
...
test_evaluator = dict(
    ann_file='data/tao/annotations/tao_val_lvis_v1_classes.json',
outfile_prefix='results/masa_results/masa-groundingdino-release_yolow_dets-test',
)
