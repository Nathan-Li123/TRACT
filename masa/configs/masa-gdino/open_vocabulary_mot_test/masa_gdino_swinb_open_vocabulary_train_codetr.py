...
model = dict(
    ...
    benchmark = 'tao',
    public_det_path = 'results/public_dets/tao_train_dets/co-detr_tao_train_dets_fil/',
...
val_dataloader = dict(
    dataset=dict(
        ann_file='data/tao/annotations/tao_train_lvis_v1_classes.json',
...
test_evaluator = dict(
    ann_file='data/tao/annotations/tao_train_lvis_v1_classes.json',
    outfile_prefix='results/masa_results/masa-codetr-tao-train',
