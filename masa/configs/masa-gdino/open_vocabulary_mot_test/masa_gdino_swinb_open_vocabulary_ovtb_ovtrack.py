_base_ = [
    ...
    '../../datasets/ovt-b/ovtb_dataset.py',
    '../../default_runtime.py'
]
default_scope = 'mmdet'
...
model = dict(
    ...
    benchmark = 'ovtb',
    public_det_path = 'results/public_dets/ovtb_dets/ovtrack_ovtb_det/',
...
val_dataloader = dict(
    dataset=dict(
        ann_file='data/ovt-b/annotations/ovtb_ann.json',
...
test_evaluator = dict(
    ann_file='data/ovt-b/annotations/ovtb_ann.json',
    outfile_prefix='results/masa_results/masa-ovtrack-ovtb_0.01',
