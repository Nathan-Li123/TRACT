...
model = dict(
    ...
    benchmark = 'tao',
    public_det_path = 'results/public_dets/tao_test_dets/regionclip_tao_test_det',
...
val_dataloader = dict(
    dataset=dict(
        ann_file='data/tao/annotations/tao_test_burst_v1.json',
...
test_evaluator = dict(
    ann_file='data/tao/annotations/tao_test_burst_v1.json',
    outfile_prefix='results/masa_results/masa-regionlcip-test_tcr_10',
